...
class Game {
  ...
  //메소드
  introduce() {
    return `${this.name}게임은 ${this.country}에서 개발,${this.download}만큼 인기가 있다~`;
  }
}
...
class Dog implements Animal {
  ...
  constructor() {}
  jump(): string {
    return `${this.name}이 ${this.age}입니다.`;
  }
}
```
